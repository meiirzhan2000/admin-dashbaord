  ...
  <div class="h-full bg-white dark:bg-gray-900">
                ...
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                            ...
                            <span
                              :class="[
                                team.current
                                  ...
                                  : 'border-gray-200 dark:border-gray-700 text-gray-400 group-hover:border-indigo-600 group-hover:text-indigo-600 dark:group-hover:border-indigo-400 dark:group-hover:text-indigo-400',
                    ...
                    <li class="mt-auto">
                      <a
                        href="/settings"
                        class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-indigo-600 dark:hover:text-indigo-400"
                      >
                        <Icon
                          name="heroicons:cog-6-tooth"
                          class="h-6 w-6 shrink-0 text-gray-400 group-hover:text-indigo-600 dark:group-hover:text-indigo-400"
                          aria-hidden="true"
                        />
                        Settings
                      </a>
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8">
        <div
          class="flex h-16 items-center gap-x-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none"
        >
          <button
            type="button"
          ...
          <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <form class="relative flex flex-1" action="#" method="GET">
              ...
              <input
                id="search-field"
                class="block h-full w-full border-0 py-0 pl-8 pr-0 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 bg-transparent focus:ring-0 sm:text-sm"
                placeholder="Search..."
                type="search"
                name="search"
              />
            ...
            <div class="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <button
                @click="toggleTheme()"
                class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-black dark:text-white rounded"
              >
                {{ isDark ? "🌞 Light" : "🌙 Dark" }}
              </button>
